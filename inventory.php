...
<body>
    ...
    <div class="register-box" id="register-box">
        ...
        <div class="form-container">
            <h2><?php echo isset($id) ? 'Edit Item' : 'Add New Item'; ?></h2>
            <form action="inv_connect.php" method="post">
                ...
                <div>
                    ...
                    <input type="text" id="cost" placeholder="cost" name="cost" required value="£ ">
                </div>
